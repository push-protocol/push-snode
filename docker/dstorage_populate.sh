...
psql -h localhost -d snode2 -U postgres -a -f ../snode/migrations/V1__init.sql &&
psql -h localhost -d snode3 -U postgres -a -f ../snode/migrations/V1__init.sql &&
psql -h localhost -d snode4 -U postgres -a -f ../snode/migrations/V1__init.sql &&
